...
var o = {
  ...
  cacheDOM: function cacheDOM() {
    ...
    for (var i = 0; i < this.animElems.length; i++) {
      this.bb8[this.animElems[i]] = this.svg.querySelector(
        "[data-bb8=" + this.animElems[i] + "]"
      );
    }
  },
  ...
  setStart: function setStart() {
    ...
    TweenMax.set(this.bb8.bb8, {
      y: 3500,
      x: 2900,
      scale: 2.5,
      transformOrigin: "center bottom",
    });
    TweenMax.set(this.bb8.rotatingHead, {
      rotation: 20,
  ...
  getRollAnims: function getRollAnims(direction) {
    ...
    tl.to(
      ...
      .to(
        this.bb8.bodyShadow,
        0.05,
        { scale: 1, transformOrigin: "center", ease: Power1.easeInOut },
        0
      )
      .to(
        this.bb8.bb8,
        5,
        { x: "-=300", ease: Power1.easeInOut, repeat: 500, yoyo: true },
        2
      )
      .to(
        this.bb8.bb8,
      ...
      .to(
        this.bb8.bodySurface,
        0.5,
        { y: "-=250", ease: Power1.easeInOut, repeat: 1000, yoyo: true },
        1
      )
      .to(
        this.bb8.bodySurface,
        5,
        { x: "+=200", ease: Power1.easeInOut, repeat: 500, yoyo: true },
        2
      )
      .to(
        this.bb8.unit,
        0.05,
        { y: "-=20", ease: Power1.easeInOut, repeat: 20000, yoyo: true },
        0.05
      )
      .to(
        this.bb8.bodyShadow,
      ...
      .to(
        ...
        0.05,
        { y: "-=30", ease: Power1.easeInOut, repeat: 20000, yoyo: true },
        0.08
      )
      .to(
        this.bb8.rotatingHead,
        10,
        {
          bezier: [{ rotation: -20 }, { rotation: 10 }, { rotation: 0 }],
          ease: Linear.easeNone,
          repeat: 100,
        },
        0
  ...
  getIntroAnim: function getIntroAnim() {
    ...
    tl.to(this.largeMask, 1.5, { scale: 0.95, ease: Back.easeInOut.config(1) })
      ...
      .to(
        this.bb8.bb8,
        4.5,
        { x: 2000, y: 4300, scale: 3, ease: Elastic.easeOut.config(10) },
        "bb8-in"
      )
      .to(
        this.bb8.bodySurface,
        4.5,
        {
          rotation: -30,
          transformOrigin: "center",
          ease: Elastic.easeOut.config(10),
        },
        "bb8-in"
      )
      .to(
        this.bb8.rotatingHead,
        0.1,
        { rotation: -20, transformOrigin: "center" },
        "bb8-in =+0.3"
      )
      .to(
        this.bb8.rotatingHead,
      ...
      .to(
        ...
        3,
        {
          rotation: -15,
          transformOrigin: "center",
          ease: Elastic.easeOut.config(0.5),
        },
        "bb8-in =+1.5"
      )
      .to(
      ...
      .add("bb8-distress")
      .staggerTo(
        [this.bb8.pupil1, this.bb8.pupil2, this.bb8.pupil3, this.bb8.pupil4],
        0.2,
        { scale: 1.5, transformOrigin: "center", repeat: 3, yoyo: true },
        0.1,
        "bb8-in =+2.5"
      )
      .add("bb8-out")
      ...
      .to(
        this.bb8.bodySurface,
        1,
        { rotation: 30, ease: Back.easeIn.config(2) },
        "bb8-out"
      )
      .to(
        this.bb8.rotatingHead,
  ...
  stopPlayNext: function stopPlayNext() {
    ...
    TweenMax.to(o.currentTl, 0.5 / o.slowMoFactor, {
      timeScale: 0,
      onComplete: o.roll,
  ...
  roll: function roll(direction) {
    ...
    for (var j = 0; j < tls.length; j++) {
      ...
      TweenMax.to(o.currentTl[j], 1 / o.slowMoFactor, {
        timeScale: o.slowMoFactorBody,
      });
    }
  },
  ...
  connectHeadToNull: function connectHeadToNull() {
    ...
    TweenMax.set(o.bb8.eyeHighlight, {
      x: eyeHighlightCenter + eyeHighlightPos,
    });
    TweenMax.set(o.bb8.littleEye, { x: littleEyeCenter + littleEyePos });
    TweenMax.set(o.bb8.antennaShort, {
      x: antennaShortCenter + antennaShortPos,
    });
  ...
  wiggleHead: function wiggleHead() {
    if (o.wiggleFrame === o.allTheTime) {
      ...
      if (o.nowAndThen) {
        TweenMax.to(o.headNull, o.ranDur, {
          value: o.moveAmount,
          ease: Power3.easeInOut,
        });
      } else {
        TweenMax.to(o.headNull, o.ranDur / 2, {
          value: "+=" + o.ranPos,
